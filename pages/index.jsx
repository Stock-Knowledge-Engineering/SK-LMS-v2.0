...
export default function Home(props) {
 ...
 <>
      ...
      <div className="lg:w-full reno:w-full md:w-full sm:w-screen xs:w-screen xxs:w-screen p-6 h-1/4">
        <h1
          id="solution"
          className="text-center lg:w-full md:w-full reno:w-full sm:w-full xs:w-full xxs:w-full lg:text-6xl reno:text-6xl md:text-6xl sm:text-4xl xs:text-4xl xxs:text-4xl font-semibold text-heading" data-aos="fade-up"
        >
          Our Solutions
        </h1>
        <br />
      ...
      <div
        id="team"
        className="md:w-full xs:w-screen xxs:w-screen p-6 h-1/4 bg-blue-50 rounded-b-full" data-aos="fade-up" data-aos-anchor-placement="top-center"
      >
