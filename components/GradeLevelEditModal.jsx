...
export default function GradeLevelEditModal(props){
    const [name, setName] = useState(props.gradelevel.name);
    const [toSubmit, setToSubmit] = useState(false);

    const [isLoading, data] = usePostHttp(toSubmit ? {id: props.gradelevel.id, school: props.gradelevel.school, name: name } : null, `/grade-level/edit`)
